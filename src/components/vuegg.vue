<template xmlns="http://www.w3.org/1999/html">
  <div class="container-fluid"
    ...
    <div class="editor">
      ...
      <div id="toolbar">
        <i data-command="back"
           class="command iconfont icon-back"
           title="返回"></i>
        ...
        <i data-command="redo"
           ...
           title="重做"></i>
        <span class="separator"></span>
        <i data-command="addBeginNode"
           class="command iconfont icon-add-begin-node"
           title="新增起始节点"></i>
        <i data-command="copy"
        ...
        <i data-command="delete"
           ...
           title="删除"></i>
        <i data-command="clear"
           class="command iconfont icon-clear"
           title="清空画布"></i>
        <span class="separator"></span>
        ...
        <span class="separator"></span>
        <i data-command="save"
           class="command iconfont icon-save"
           title="保存"></i>
      </div>
      ...
      <div class="editor-content">
        ...
        <div class="right-side">
          ...
          <div id="detailpannel">
              ...
              <div class="pannel-container">
                <el-form ref="form"
                  ...
                  <el-form-item label="条件"
                                v-if="showCond">
                    <el-select v-model="condType"
                               placeholder="请选择条件"
                               @change="condTypeSelectChange">
                      <el-option v-for="(cItem, cIndex) in conditionList"
                                 :label="cItem.name"
                                 :value="cItem.code"
                                 :key="cIndex"></el-option>
                    </el-select>
                  </el-form-item>
                  <el-form-item label="判断方法"
                                v-if="showOperator">
                    <el-select v-model="operator"
                               @change="enableChangeData">
                      <el-option v-for="(oItem, oIndex) in operatorList"
                                 :label="oItem.name"
                                 :value="oItem.code"
                  ...
                  <el-form-item label="值"
                    ...
                    <el-select v-model="value"
                               @change="enableChangeData"
                               filterable>
                      <el-option v-for="(vItem, vIndex) in valueList"
                                 :label="vItem.name"
                                 :value="vItem.code"
                                 :key="vIndex"></el-option>
                    </el-select>
                  </el-form-item>

                  <el-form-item label="疾病"
                                v-if="showDisease">
                    <el-badge :value="diseaseSelectedLength"
                              class="item">
                      <div title="选择既往史"
                           class="btn btn-disease-setting"
                           @click="showDiseaseDialog"><i class="ti-settings"></i></div>
                    </el-badge>
                  </el-form-item>
                  ...
                  <el-form-item label="级别"
                    ...
                    <el-col :span="11">
                      <el-select v-model="grade"
                                 @change="enableChangeData">
                        <el-option v-for="(gItem, gIndex) in gradeList"
                                   :label="gItem.name"
                                   :value="gItem.code"
                                   :key="gIndex"></el-option>
                      </el-select>
                    </el-col>
                    <el-col class="line"
                            :span="2"></el-col>
                  ...
                  <el-form-item label="程度"
                    ...
                    <el-col :span="9">
                      <el-select v-model="level"
                                 @change="enableChangeData">
                        <el-option v-for="(lItem, lIndex) in levelList"
                                   :label="lItem.name"
                                   :value="lItem.code"
            ...
            <div data-status="multi-selected"
                 class="pannel">
          ...
          <div id="navigator">
            ...
            <div class="zoom-slider">
              <div class="slider-outer-ctn">
                <el-slider v-model="zoomSlider"
                           :format-tooltip="formatTooltip"
                           @change="changeZoom"
                           :min="minZoom * 100"
                           :max="maxZoom * 100"></el-slider>
              </div>
              <el-dropdown class="dropdown-inner-ctn"
        ...
        <div id="contextmenu">
          <div data-status="node-selected"
               class="menu">
            <div data-command="copy"
                 class="command">复制</div>
            <div data-command="paste"
                 class="command">粘贴</div>
            <div data-command="delete"
                 class="command">删除</div>
          </div>
          <div data-status="edge-selected"
               class="menu">
            <div ton
          ...
          <div data-status="group-selected"
            ...
            <div data-command="paste"
                 class="command">粘贴</div>
            <div data-command="unGroup"
                 class="command">解组</div>
            <div data-command="delete"
                 class="command">删除</div>
          </div>
          <div data-status="canvas-selected"
            ...
            <div data-command="undo"
                 class="command">撤销</div>
            <div data-command="redo"
                 class="command disable">重做</div>
          </div>
          <div data-status="multi-selected"
               class="menu">
            <div data-command="copy"
    ...
    <!--疾病选择弹窗 start-->
    <el-dialog :custom-class="diseaseDialogClass"
               title="选择疾病"
      ...
      <div class="select-disease-list">
        <el-tag v-for="(item, index) in selectDiseases"
                :key="item.id"
      ...
      <span slot="footer"
        ...
        <el-button type="primary"
                   @click="submitSelectDisease">确 定</el-button>
      </span>
    </el-dialog>
    <!--疾病选择弹窗 end-->
