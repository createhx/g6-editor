<template>
  <div class="toolbar">
    ...
    <i class="command iconfont icon-undo"
       title="撤销"
       :class="undoList.length>0?'':'disable'"
       @click="handleUndo"></i>
    <i class="command iconfont icon-redo"
       title="重做"
...
export default {
  ...
  methods: {
    ...
    consoleData () {
      ...
      localStorage.setItem("data", JSON.stringify(this.graph.save()))
    }
  }
};
</script>
